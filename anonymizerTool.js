...
{var script_path="https://cdn.rawgit.com/suryadewa/shorturl/master/anonymize.js";var keywords=document.forms[formName].elements["keywords"].value;keywords=keywords.replace(" ","");var keywords_array=new Array();var the_code="";keyword_array=keywords.split(",");the_code+="<script src=\""+ script_path+"\" type=\"text/javascript\"></script>\n";the_code+="<script type=\"text/javascript\">\n";the_code+="protected_links = \""+ keyword_array.join(", ")+"\";\n";the_code+="auto_anonymize();\n";the_code+="</script>\n";displayCode(displayIn,the_code);}
